...
- [x] **Step 3: Add the typed catalog and remote image allowlist**
...
- [x] **Step 2: Run the focused guest test**
...
- [x] **Step 3: Implement the reusable image component and map images to surfaces**
...
- [x] **Step 4: Run the focused guest test**
...
- [x] **Step 1: Add structural assertions for grouped consumer-app components**
...
- [x] **Step 3: Update markup and CSS**
...
- [x] **Step 4: Run focused tests and CSS checks**
...
- [x] **Step 1: Add a failing catalog regression test**
...
- [x] **Step 3: Align the catalog copy and shared visual tokens**
...
- [x] **Step 5: Verify the live app in the browser**
