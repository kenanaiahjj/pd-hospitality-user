...
/*
  ...
  These files keep the promoted flow deterministic while the property-owned
  photography is being finalized. Replace them with approved property assets
  without changing the story model.
*/
...
/*
  ...
  Copied once into `public/experiments/`; the filename is the Unsplash id so
  each one can still be traced back to its source.
*/
